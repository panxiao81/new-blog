...
![image-20201210112358733](/images/EX200/image-20201210112358733.png)

选择需要配置IP的网卡名称,如 `eth0`，再选择右边的 `Edit`（结合左右键和上下键），回车

![image-20201210112502986](/images/EX200/image-20201210112502986.png)

上下键选择IPv4后面的回车.

![image-20201210112523664](/images/EX200/image-20201210112523664.png)

选择 `Manual` (手动配置IP)，回车

![image-20201210112618967](/images/EX200/image-20201210112618967.png)
...
![image-20201210112813602](/images/EX200/image-20201210112813602.png)
...
![image-20201210112909432](/images/EX200/image-20201210112909432.png)

选择下面的 `Back` 返回

![image-20201210112944838](/images/EX200/image-20201210112944838.png)
...
![](/images/EX200/2020-12-10-23-44-48.png)

重启虚拟机

进入到如下界面按 `↑` 键，之后按 `e` 键

![](/images/EX200/2020-12-10-23-45-30.png)

按 `e` 键后，找到 `linux` 这一行，将原来的 `ro` 修改为 `rw` ，再手动添加空格 `rd.break`

![](/images/EX200/2020-12-10-23-46-45.png)
...
![](/images/EX200/2020-12-11-00-08-00.png)
...
![](/images/EX200/2020-12-11-00-08-59.png)

此逻辑卷应当在系统启动时自动挂载到 `/mnt/mydata` 目录

![](/images/EX200/2020-12-11-00-09-43.png)

使用 `vim /etc/fstab` 进入到配置文件

在最后输入 如下图

![](/images/EX200/2020-12-11-00-10-15.png)
...
![](/images/EX200/2020-12-11-00-12-01.png)

此VDO卷使用xfs文件系统格式化

![](/images/EX200/2020-12-11-00-12-24.png)

在系统启动是自动挂载到/vblock目录下

![](/images/EX200/2020-12-11-00-12-47.png)

使用 `vim /etc/fstab` 命令打开配置文件，在最后输入如下图

![](/images/EX200/2020-12-11-00-13-15.png)

## 配置系统调优

如下图

![](/images/EX200/2020-12-11-00-13-50.png)
